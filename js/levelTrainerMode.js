// ====================================================================
// levelTrainerMode.js — Тренажёр "Все фразы уровня" (6 КНОПОК, БЕЗ ПЕРЕМЕШИВАНИЯ, ВОЛНЫ)
// ====================================================================
...
console.log('🧩 levelTrainerMode.js загружен (6 КНОПОК, ВОЛНЫ, БЕЗ ПЕРЕМЕШИВАНИЯ ПРИ ВЫБОРЕ)');
